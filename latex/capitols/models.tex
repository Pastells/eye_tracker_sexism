...
\begin{enumerate}
    ...
    \item Dades. Cal seleccionar grups petits d'AOI i els seus respectius temps a Times of interest. Finalment es van fer 4 grups de 10 textos per cada participant.
        \begin{itemize}
