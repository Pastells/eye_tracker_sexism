...
\begin{enumerate}
    ...
    \item \textbf{Validació manual}: cada text candidat es va revisar individualment. Es va escoltar l'àudio original i es van inspeccionar visualment les anotacions de segments per confirmar-ne l'adequació.
\end{enumerate}
