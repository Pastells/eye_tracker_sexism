...
\cite{malik2025deep,gandhi2024hate,plaza2025overview}.
...
\cite{rayner1998eye,rayner2009eye}. Mètriques com la durada total de
...
requereixen un processament més profund \cite{clifton2007eye}.
...
% El treball s'estructura de la manera següent: el capítol~\ref{ch:marc}
% presenta el marc teòric, al capítol~\ref{ch:design} es descriu el
