...
En segon lloc, LRP és el mètode d'interpretabilitat que produeix les distribucions més properes a l'atenció humana en tots els models (SD: 2,99--4,12), possiblement per la seva naturalesa de descomposició exacta del gradient, que preserva la informació contributiva del model.
