La detecció del sexisme és una preocupació creixent en el Processament del Llenguatge Natural (PLN), però poc se sap sobre els patrons que humans i models utilitzen per identificar-lo. Comprendre'ls pot il·luminar processos cognitius i millorar la interpretabilitat dels models.

En aquest treball comparem la lectura humana amb l'atenció dels models. Hipotetitzem que humans i models es fixen en regions parcialment coincidents però diferents, i que els humans mostren més sensibilitat als indicis pragmàtics, especialment per sexisme implícit.

Dissenyem un experiment d'eye-tracking amb 10 participants que llegeixen textos en castellà d'un corpus multimodal de sexisme. Els participants proporcionen judicis binaris i valoracions de confiança, seguits d'entrevistes de record estimulat. Computacionalment, extraiem l'atenció de models de llenguatge codificadors.

Correlacionem les durades de fixació amb els pesos d'atenció, avaluant-los contra les anotacions de referència. En fonamentar la interpretabilitat en dades cognitives, aquest treball connecta la psicolingüística i el PLN.
\vspace{0.5cm}
