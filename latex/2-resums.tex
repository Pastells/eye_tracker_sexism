...
Dissenyem un experiment d'eye-tracking amb 10 participants que llegeixen textos en castellà d'un corpus multimodal de sexisme. Els participants proporcionen judicis binaris i valoracions de confiança, seguits d'entrevistes de record estimulat. Computacionalment, extraiem l'atenció de models codificadors (BERT, RoBERTa) i LLMs (Ministral 3, Gemma 4).

Correlacionem les durades de fixació amb els pesos d'atenció, avaluant-los contra les anotatcions de referència. En fonamentar la interpretabilitat en dades cognitives, aquest treball connecta la psicolingüística i el PLN.
\vspace{0.5cm}
